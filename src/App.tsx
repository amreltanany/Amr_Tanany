...
import { getFaviconWithFallback } from "./utils";
...
const projects: Project[] = [
  {
    ...
    favicon: getFaviconWithFallback("https://tajclinics-7f4tfgfb.manus.space/"),
  },
  {
    ...
    favicon: getFaviconWithFallback("https://amreltanany.github.io/MeridianBuild/"),
  },

  {
    ...
    favicon: getFaviconWithFallback("https://samconstructions-eg.com/"),
  },
  {
    ...
    favicon: getFaviconWithFallback("https://amreltanany.github.io/Switch-On/"),
  },
  {
    ...
    url: "http://qaro2a.com/",
    favicon: getFaviconWithFallback("http://qaro2a.com/"),
  },
  {
    ...
    favicon: getFaviconWithFallback("https://displayegypt.com/"),
  },
  {
    ...
    favicon: getFaviconWithFallback("https://amreltanany.github.io/apex-nine-racing/"),
  },
{
    ...
    favicon: getFaviconWithFallback("https://amreltanany.github.io/Amr_Portfolio/"),
  },
{
   ...
   image: `${import.meta.env.BASE_URL}imports/porfolio2.jpeg`, tags: ["React + Vite"," TypeScript","Tailwind"], accent: "copper",
    ...
    favicon: getFaviconWithFallback("https://amreltanany.github.io/ElTanany/"),
  },
{
    ...
    favicon: getFaviconWithFallback("https://amreltanany.github.io/portfolio-/"),
  },
  {
    ...
    favicon: getFaviconWithFallback("https://amreltanany.github.io/ronin/"),
  },
];
